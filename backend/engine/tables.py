...
WRITABLE_FIELDS: dict[str, dict] = {
    ...
    "minister.*.abilities.administration": {"type": "int"},
    "minister.*.abilities.knowledge":      {"type": "int"},
    "minister.*.abilities.politics":       {"type": "int"},
    "minister.*.ambition":               {"type": "int"},
    "minister.*.influence":              {"type": "int"},
